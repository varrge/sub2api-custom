...
func TestGetUserGroupRateMultiplier_CacheHitAndNilRepo(t *testing.T) {
	...
	key := "101:202"
	svc.userGroupRateCache.Set(key, cachedUserGroupRate{multiplier: 2.3, overridden: true}, time.Minute)
	...
	svc2.userGroupRateCache.Set(key, cachedUserGroupRate{multiplier: 1.9, overridden: true}, time.Minute)
