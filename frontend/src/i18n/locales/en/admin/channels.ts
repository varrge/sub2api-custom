export default {
    ...
    channels: {
      ...
      form: {
        ...
        billingMode: 'Billing Mode',
        defaultPrices: 'Base prices (official defaults, custom overrides allowed)',
        defaultPricesHint: 'Custom values override the default base prices for this rule and are shown as base prices in Model Plaza. Effective group multipliers apply to the paid price. Matching context tiers take precedence when configured.',
        inputPrice: 'Input',
        outputPrice: 'Output',
        cacheWritePrice: 'Cache Write',
        cacheWrite5mPrice: 'Cache Write (5m)',
