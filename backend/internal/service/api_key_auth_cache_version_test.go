...
func TestAPIKeyService_RejectsV24AuthSnapshotBeforeMergedModelAllowlist(t *testing.T) {
	svc := &APIKeyService{}
	apiKey, ok, err := svc.applyAuthCacheEntry("k-before-custom-model-allowlist", &APIKeyAuthCacheEntry{
