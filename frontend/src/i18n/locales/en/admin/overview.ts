export default {
    ...
    groups: {
      ...
      temporaryRate: {
        ...
        endDate: 'End time',
        hint: 'Temporarily replaces the group default. User-specific rates take priority and peak rates still multiply it. Times use the server timezone {timezone}, precise to the second. Starts at the start time and expires at the end time.',
        multiplierInvalid: 'Limited-time rate must be greater than 0',
        datesRequired: 'Start and end times are required when the limited-time rate is enabled',
        rangeInvalid: 'End time must be later than start time',
        status: {
          upcoming: 'Upcoming',
          active: 'Active',
          ended: 'Ended',
      ...
      modelPricing: {
        title: 'Group model prices (optional overrides)',
        description: 'For shared base prices, leave this empty to inherit channel or default prices and set only the group multiplier. Import prices in bulk or add overrides when this group needs its own prices. Long-context tiers use official presets. Audio supports per-request tiers such as realtime, tts, and stt.',
