...
var (
	...
	APIKeysColumns = []*schema.Column{
		...
		{Name: "multi_group_enabled", Type: field.TypeBool, Default: false},
		{Name: "model_allowlist", Type: field.TypeJSON},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "temporary_rate_enabled", Type: field.TypeBool, Default: false},
		{Name: "temporary_rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "temporary_rate_starts_at", Type: field.TypeTime, Nullable: true},
		{Name: "temporary_rate_ends_at", Type: field.TypeTime, Nullable: true},
	...
	SupportTicketsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt64, Increment: true},
		{Name: "title", Type: field.TypeString, SchemaType: map[string]string{"postgres": "varchar(200)"}},
