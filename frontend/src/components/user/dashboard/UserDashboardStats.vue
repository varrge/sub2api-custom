<template>
  ...
  <div class="dashboard-metrics">
    <!-- Balance -->
    <div v-if="!isSimple" class="card dashboard-metric">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-semibold tracking-tight tabular-nums text-primary-600 dark:text-primary-400">${{ formatBalance(balance) }}</p>
    ...
    <div class="card dashboard-metric">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-semibold tracking-tight tabular-nums text-gray-900 dark:text-white">{{ stats?.total_api_keys || 0 }}</p>
    ...
    <div class="card dashboard-metric">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-semibold tracking-tight tabular-nums text-gray-900 dark:text-white">{{ stats?.today_requests || 0 }}</p>
    ...
    <div class="card dashboard-metric">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-semibold tracking-tight tabular-nums text-gray-900 dark:text-white">
            <span class="text-primary-600 dark:text-primary-400" :title="t('dashboard.actual')">${{ formatCost(stats?.today_actual_cost || 0) }}</span>
            <span class="text-sm font-normal text-gray-500 dark:text-dark-400" :title="t('dashboard.standard')"> / ${{ formatCost(stats?.today_cost || 0) }}</span>
          </p>
          <p class="text-xs">
            ...
            <span class="text-gray-500 dark:text-dark-400" :title="t('dashboard.standard')"> / ${{ formatCost(stats?.total_cost || 0) }}</span>
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="card dashboard-metric">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-semibold tracking-tight tabular-nums text-gray-900 dark:text-white">{{ formatTokens(stats?.today_tokens || 0) }}</p>
    ...
    <div class="card dashboard-metric">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-semibold tracking-tight tabular-nums text-gray-900 dark:text-white">{{ formatTokens(stats?.total_tokens || 0) }}</p>
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex-1">
          ...
          <div class="flex items-baseline gap-2">
            <p class="text-xl font-semibold tracking-tight tabular-nums text-gray-900 dark:text-white">{{ formatTokens(stats?.rpm || 0) }}</p>
            <span class="text-xs text-gray-500 dark:text-gray-400">RPM</span>
          </div>
          <div class="flex items-baseline gap-2">
            <p class="text-sm font-semibold text-gray-700 dark:text-dark-200">{{ formatTokens(stats?.tpm || 0) }}</p>
    ...
    <div class="card dashboard-metric">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-xl font-semibold tracking-tight tabular-nums text-gray-900 dark:text-white">{{ formatDuration(stats?.average_duration_ms || 0) }}</p>
