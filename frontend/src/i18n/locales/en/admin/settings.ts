export default {
    settings: {
      ...
      activityLeaderboard: {
        ...
        description: 'Configure the consumption leaderboard shown from the trophy entry in the user header. This configuration is saved independently via this card’s save button, not the global save.',
        enabled: 'Enable leaderboard',
        enabledHint: 'When disabled, the trophy entry is hidden. Other open pages update within about one minute.',
        fieldTitle: 'Activity title',
        fieldTitleHint: 'Required, 1–80 characters. Shown at the top of the leaderboard popover.',
        fieldSubtitle: 'Subtitle',
        fieldSubtitleHint: 'Optional, up to 160 characters. Leave empty to hide this line.',
        fieldReward: 'Reward description',
        fieldRewardHint: 'Optional, up to 1000 characters. Leave empty to hide this line.',
        startsAt: 'Start time',
        endsAt: 'End time',
        timeHint: 'Entered in Beijing time (UTC+08:00), independent of the browser timezone. The period includes the start and excludes the end.',
        demoExpiresAt: 'Demo data expiry',
        demoExpiresAtClear: 'Clear',
        demoExpiresAtHint: 'Optional and must not be later than the start time. Simulated entries are shown only before the activity starts and stop automatically on expiry or at the official start; demo data is never billed or written to the database.',
        timeZoneNote: 'All times are entered and displayed in Beijing time (UTC+08:00).',
        billingNote: 'The leaderboard ranks billed credits, not the amount paid in CNY.',
        rulesNote: 'Scope: usage across all groups counts — balance, subscriptions and group-buy month cards after promotions and personal rates. Top-ups and package purchases do not count. The board shows the top 20 plus the viewer’s own rank; users appear as anonymous aliases.',
        loadFailed: 'Failed to load the leaderboard configuration. Please retry.',
        retry: 'Retry',
        saved: 'Leaderboard configuration saved',
        saveFailed: 'Failed to save the leaderboard configuration',
        validation: {
          title: 'The activity title is required and must be at most 80 characters.',
          subtitle: 'The subtitle must be at most 160 characters.',
          rewardDescription: 'The reward description must be at most 1000 characters.',
          periodRequired: 'Please provide valid start and end times.',
          periodOrder: 'The start time must be earlier than the end time.',
          periodLength: 'The activity period must not exceed 366 days.',
          demoInvalid: 'The demo expiry time is invalid.',
          demoAfterStart: 'The demo expiry must not be later than the activity start time.',
        },
      },
      panelRateLimit: {
