...
func TestUserAvailableChannel_FieldWhitelist(t *testing.T) {
	...
	for _, key := range []string{"id", "name", "platform", "subscription_type", "rate_multiplier", "temporary_rate_enabled", "temporary_rate_multiplier", "temporary_rate_starts_at", "temporary_rate_ends_at", "peak_rate_enabled", "peak_start", "peak_end", "peak_rate_multiplier", "is_exclusive"} {
