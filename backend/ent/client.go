...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.SupportTicketRead, c.TLSFingerprintProfile, c.UsageCleanupTask, c.UsageLog,
...
// QueryReader queries the reader edge of a SupportTicketRead.
func (c *SupportTicketReadClient) QueryReader(_m *SupportTicketRead) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
