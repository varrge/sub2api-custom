...
> 2026-09-17 需求修订：官方订阅与拼团月卡独立管理。`/subscriptions` 仅展示官方订阅；新增 `/my-group-buy`（我的拼团）管理拼团与独购月卡。购买页保留“充值”“订阅”，独立增加“拼团”页签。关闭官方订阅不影响拼团与已购月卡；同组消耗顺序和跨权益扣费规则保留。下文早期合并页面的描述由此修订取代。
