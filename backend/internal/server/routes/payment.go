...
func RegisterPaymentRoutes(
	...
	if h := paymentHandler.GroupBuy; h != nil {
		...
		groupBuy.GET("/rules", h.Rules)
		groupBuy.POST("/rules/read", h.ReadRule)
		groupBuy.POST("/coupons/preview", h.PreviewCoupon)
		...
		adminGroupBuy.GET("/rules", h.AdminRules)
		adminGroupBuy.PUT("/rules", h.SaveRules)
		adminGroupBuy.POST("/rules/publish", h.PublishRules)
		adminGroupBuy.GET("/freeze-policy", h.FreezePolicy)
		adminGroupBuy.PUT("/freeze-policy", h.SetFreezePolicy)
		adminGroupBuy.GET("/coupons", h.AdminCoupons)
		adminGroupBuy.POST("/coupons", h.SaveCoupon)
		adminGroupBuy.PUT("/coupons/:id", h.SaveCoupon)
