...
// ByMultiGroupEnabled orders the results by the multi_group_enabled field.
func ByMultiGroupEnabled(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldMultiGroupEnabled, opts...).ToFunc()
}
