export default {
    scheduledTests: {
      ...
      onlyWhenModelLimited: 'Test only while model is limited',
      onlyWhenModelLimitedHelp: 'Stand by while healthy. Test on the cron schedule when the model or account is rate limited; return to standby after recovery and resume if limited again.',
      modelRecoverHelp: 'On success, clear only the tested model limits and observed account rate limit; preserve other models and manual account settings.',
