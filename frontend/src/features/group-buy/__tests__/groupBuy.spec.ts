...
vi.mock('@/api/groupBuy', () => ({ groupBuyAPI: { setOrder: vi.fn().mockResolvedValue(undefined) } }))
...
describe('group buy purchase and quota boundaries', () => {
  ...
  it.each([{ ...team, joined: true }, { ...team, status: 'closed' as const }, { ...team, member_count: 10 }, { ...team, closes_at: '2000-01-01T00:00:00Z' }])('disables duplicate or unavailable team checkout', current => {
