...
const ACCENT_DEFAULT = '#c9976f' // primary-600 (gold)
...
const BUTTON_DEFAULT = 'bg-primary-500 text-on-primary hover:bg-primary-600 dark:bg-primary-600 dark:hover:bg-primary-500'
