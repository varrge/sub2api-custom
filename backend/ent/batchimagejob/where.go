...
func BillingSnapshotIsNil() predicate.BatchImageJob {
	return predicate.BatchImageJob(sql.FieldIsNull(FieldBillingSnapshot))
}

// BillingSnapshotNotNil applies the NotNil predicate on the "billing_snapshot" field.
func BillingSnapshotNotNil() predicate.BatchImageJob {
	return predicate.BatchImageJob(sql.FieldNotNull(FieldBillingSnapshot))
}
